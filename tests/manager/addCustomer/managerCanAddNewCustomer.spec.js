...
*/
  ...
  await customersListPage.waitForPageLoad();

  await customersListPage.assertLastAddedCustomerFirstName(firstName);
  await customersListPage.assertLastAddedCustomerLastName(lastName);
  await customersListPage.assertLastAddedCustomerPostCode(postCode);
  await customersListPage.assertLastAddedCustomerAccountNumberIsAbsent();
});