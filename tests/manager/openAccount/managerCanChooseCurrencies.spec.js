...
await openAccountPage.assertCurrencyDropdownContainsValue('Dollar'); 
await openAccountPage.selectCurrency('Pound');  
await openAccountPage.assertCurrencyDropdownContainsValue('Pound'); 
await openAccountPage.selectCurrency('Rupee');
await openAccountPage.assertCurrencyDropdownContainsValue('Rupee');
});
