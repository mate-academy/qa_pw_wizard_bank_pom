...
*/
  ...
  await bankManagerMainPage.clickopenAccountButtonTab();
  await openAccountPage.selectUserOption(`${firstName} ${lastName}`);
  ...
  await customersListPage.tableLastRowFourthCellNotEmpty();
});