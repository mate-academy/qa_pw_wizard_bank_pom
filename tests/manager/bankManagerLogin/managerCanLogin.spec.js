...
*/
  const bankPage = new BankHomePage(page);
  const bankManagerMainPage = new BankManagerMainPage(page);

  await bankPage.open();
  await bankPage.clickManagerLoginButton();
  await bankManagerMainPage.addCustomerButtonTabVisible();
  await bankManagerMainPage.openAccountButtonTabVisible();
  await bankManagerMainPage.customersButtonTabVisible();
});